#
# Module manifest for module 'PS2EXE.Core'
#
# Generated by: Fabien Tschanz
#
...
@{
    ...
    GUID                   = '2c726bc6-2a7c-4707-a676-1d3b48a0d3ec'

    # Author of this module
    Author                 = 'Fabien Tschanz'

    # Company or vendor of this module
    CompanyName            = ''

    # Copyright statement for this module
    Copyright              = '(c) Fabien Tschanz 2026'
...
'@
    ...
    PrivateData            = @{
        ...
        PSData = @{
            ...
            LicenseUri   = 'https://github.com/FabienTschanz/PS2EXE.Core/blob/master/LICENSE'

            # A URL to the main website for this project.
            ProjectUri   = 'https://github.com/FabienTschanz/PS2EXE.Core'
